...
@Component({
  selector: 'infinite-scroll-small-items-page',
  standalone: true,
  imports: [ArdiumInfiniteScrollModule],
  templateUrl: './infinite-scroll-small-items.page.html',
  styleUrl: './infinite-scroll-small-items.page.scss',
})
export class InfiniteScrollSmallItemsPage {
